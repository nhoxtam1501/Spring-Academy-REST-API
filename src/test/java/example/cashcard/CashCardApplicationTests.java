...
class CashCardApplicationTests {
	...
	void shouldNotDeleteACashCardThatDoesNotExist() {
		ResponseEntity<Void> deleteRepsonse = restTemplate.withBasicAuth("sarah1", "abc123")
				.exchange("/cashcards/9999999", HttpMethod.DELETE, null, Void.class);

		assertThat(deleteRepsonse.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
	}
	...
	@Test
	void shouldNotAllowDeletetionOfCashCardsTheyDoNotOwn() {
